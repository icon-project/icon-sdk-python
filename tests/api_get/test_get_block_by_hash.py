...
class TestGetBlockByHash(TestSendSuper):
    def test_get_block_by_hash(self):
        with requests_mock.Mocker() as m:
            valid_block_hash: str = "0x033f8d96045eb8301fd17cf078c28ae58a3ba329f6ada5cf128ee56dc2af26f7"
            ...
            result = self.icon_service.get_block(valid_block_hash)
    ...
    def test_get_block_by_invalid_hash(self):
        with requests_mock.Mocker() as m:
            invalid_block_hash: str = "0x033f8d96045eb8301fd17cf078c28ae58a3ba329f6ada5cf128ee56dc2af26f7"
            expected_request_body: dict = {
                'id': 1234,
                'jsonrpc': '2.0',
                'method': 'icx_getBlockByHash',
